...
class CoRL2017_Any2(ExperimentSuite):
    ...
    def _poses_town02(self):
        ...
        def _poses_one_curve():
            # return [[77, 34], [40, 63], [58, 76], [79, 55], [16, 61], [27, 11]]
        ...
        def _poses_navigation():
            # return [[19, 66], [79, 14], [19, 57], [23, 1], [10, 61], [66, 3], [79, 19]
        #         , [2, 29], [16, 14], [5, 57], [70, 73], [57, 50]]
    ...
    def _poses_town02_lite(self):


        def _poses_navigation():
            return [[12,10], [12, 8], [17, 26]]
    ...
    def build_experiments(self):
        ...
        if self._city_name == 'Town01_lite':
            poses_tasks = self._poses_town01_lite()
            vehicles_tasks = [20]
            pedestrians_tasks = [50]
        elif self._city_name == 'Town02_lite':
            poses_tasks = self._poses_town02_lite()
            vehicles_tasks = [0]
            pedestrians_tasks = [0]
        elif self._city_name == 'Town01':
